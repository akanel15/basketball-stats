...
describe("sanitizeFileName", () => {
  it("should convert spaces to dashes", () => {
    expect(sanitizeFileName("Lakers vs Warriors")).toBe("Lakers-vs-Warriors.png");
  });

  it("should remove special characters", () => {
    expect(sanitizeFileName("Our Team @ Opponent!")).toBe("Our-Team-Opponent.png");
  });

  it("should collapse multiple spaces into single dash", () => {
    expect(sanitizeFileName("  Team  A   vs   Team  B  ")).toBe("Team-A-vs-Team-B.png");
  });
  ...
  it("should handle custom file extension", () => {
    expect(sanitizeFileName("Team A vs Team B", "jpg")).toBe("Team-A-vs-Team-B.jpg");
  });
  ...
  it("should preserve existing dashes in names", () => {
    expect(sanitizeFileName("Some-Team vs Other-Team")).toBe("Some-Team-vs-Other-Team.png");
  });
});
